...
namespace tModPorter.Rewriters.MethodDeclarationRewriters
{
    ...
    {
        public UseItemReturnRewriter(SemanticModel model, List<string> usingList, HashSet<(BaseRewriter rewriter, SyntaxNode originalNode)> nodesToRewrite) : base(model, usingList, nodesToRewrite) { }
